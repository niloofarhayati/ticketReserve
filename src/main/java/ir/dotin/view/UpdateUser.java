...
public class UpdateUser extends WebPage implements Serializable {
    private Label label;
    ...
    public UpdateUser(final PageParameters parameters) {
            ...
            if (Constants.LOGIN) {
                ...
                form.add(new Button("button") {
                    ...
                    public void onSubmit() {
                        ...
                        Boolean b = am.update(in.toString(), first, last, username, pass, ty);
                        if (b) {
                            label.setDefaultModelObject("به روز رسانی با موفقیت انجام شد");
                        } else {
